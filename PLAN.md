...
| 2026-08-29 | **Gramática A2 verificada** con formas reales: terminaciones del aoristo por clase de verbo (-ψα/-ξα/-σα según el tema, con las excepciones de Β1/Β2 que **no son predecibles por regla** y van como lista cerrada), la regla del aumento έ- y por qué desaparece en 1ª/2ª plural, ~30 aoristos irregulares obligatorios, futuro/subjuntivo/imperativo, mediopasiva, y las **tablas de declinación completas** con las tres causas distintas del desplazamiento del acento. Fuentes en CURRICULUM.md §6 |
| 2026-08-29 | **Primer módulo A2 escrito y sembrado: «La casa y el barrio»** (47 entradas, ancla el **genitivo**). Soporte de **varios niveles** en el seed: el curso pasa de 7 a 8 módulos y de 51 a 63 lecciones, con el progreso conservado. Cuatro notas contrastivas nuevas del A2: el genitivo (**el orden coincide con el español**, el coste está solo en la forma), el **acento que se mueve** al declinar (el español nunca lo hace — es lo más ajeno del nivel), los **deponentes** como lista cerrada (*vengo* no es reflexivo en español pero solo existe έρχομαι), y μου αρέσει, que calca la estructura de *me gusta*. `gender_sort` por fin aparece de verdad: los sustantivos de casa tienen artículo |
| 2026-08-29 | **A2 completo: los 7 módulos.** Casa/genitivo · aoristo regular · aoristo irregular · futuro · subjuntivo · imperativo · salud y condicionales. **517 palabras, 114 lecciones, 1122 ejercicios** (el doble que con solo A1), con 18 tarjetas de regla nuevas. Todas las formas verificadas contra los manuales antes de escribirlas — el reparto -ησα/-εσα del tipo Β2 va como lista de memoria porque **no es predecible por regla**, y eso solo se sabe habiéndolo comprobado |
| 2026-08-29 | **Tres bugs del seed que solo aparecieron con el doble de contenido.** (1) `phrase_blank` acaparaba dos tercios de las lecciones de futuro y subjuntivo, donde casi toda entrada es una frase → ahora alterna con `listen_choose`. (2) Los trozos de 3 entradas daban lecciones de 5 ejercicios y 2 tipos → mínimo 4. (3) **Reordenar en sitio chocaba con la unicidad de `(lessonId, order)`**: si un ejercicio pasa de la posición 3 a la 1, el que ya ocupa la 1 bloquea el upsert. Se resuelve en dos fases (apartar a un rango temporal, luego colocar), y hubo que limpiar los huérfanos **antes** de crear, no al final. Resultado: racha máx 2, mínimo 3 tipos, media de 9,8 ejercicios |
| 2026-08-29 | La validación admite ahora el **apóstrofo de elisión** (`πάρ' το`, `μ' αρέσει`): es ortografía griega correcta y rechazarla obligaba a escribir formas menos naturales solo para pasar el validador — la validación mandando sobre el contenido en vez de al revés |
---
